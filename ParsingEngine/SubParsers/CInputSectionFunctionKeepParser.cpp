        ...
        if (localIterator == endOfVectorIterator)
        {
            ...
            default:
                throw CMasterParsingException(
                    ...
                    "ParserState invalid in CInputSectionFunctionKeepParser");
            }
        }
        ...
        switch (localIterator->EntryType())
        {
            ...
            case RawEntryType::Word:
            {
                switch (parserState)
                {
                    case ParserState::AwaitingHeader:
                    {
                        if (CParserHelpers::IsKeepFunction(resolvedContent)) {
                    ...
                    case ParserState::AwaitingParenthesisClosure:
                    {
                        auto parsedStatement = statementParser.TryParse(linkerScriptFile, localIterator, endOfVectorIterator);
            ...
            case RawEntryType::Comma:
            {
                switch (parserState)
                {
                    ...
                    case ParserState::AwaitingParenthesisClosure:
                    {
                        violations.emplace_back(std::shared_ptr<CViolationBase>(new CParserViolation(*localIterator, EParserViolationCode::FunctionDoesNotSupportMultipleParameters)));
                        break;
                    }
