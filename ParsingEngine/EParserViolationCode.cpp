...
std::string VisualLinkerScript::ParsingEngine::MapParserViolationCodeToString(EParserViolationCode code)
{
    switch (code)
    {
        ...
        case EParserViolationCode::IncompleteMemoryDefinition: return "IncompleteMemoryDefinition";
        ...
        case EParserViolationCode::AllocatableAttributeIsAlreadySet: return "AllocatableAttributeIsAlreadySet";
        case EParserViolationCode::CompoundAssignmentOperatorNotAllowedHere: return "CompoundAssignmentOperatorNotAllowedHere";
		...
		case EParserViolationCode::ParenthesisClosureForExpressionIsMissing: return "ParenthesisClosureForExpressionIsMissing";
        ...
        case EParserViolationCode::RValueExpressionMissing: return "RValueExpressionMissing";
        ...
        case EParserViolationCode::ExpectedSemicolonWasNotFound: return "ExpectedSemicolonWasNotFound";
        case EParserViolationCode::AssignmentIsMissingParenthesisClosure: return "AssignmentIsMissingParenthesisClosure";
		...
		case EParserViolationCode::SectionOutputDefinitionIncomplete: return "SectionOutputDefinitionIncomplete";
		case EParserViolationCode::SectionOutputBracketClosureMissing: return "SectionOutputBracketClosureMissing";
		...
		case EParserViolationCode::VersionScriptBracketClosureMissing: return "VersionScriptBracketClosureMissing";
		case EParserViolationCode::VersionScriptSemicolonMissing: return "VersionScriptSemicolonMissing";
        ...
        case EParserViolationCode::SectionsRegionBracketClosureMissing: return "SectionsRegionBracketClosureMissing";
        case EParserViolationCode::PhdrsRegionParsingFailed: return "PhdrsRegionParsingFailed";
        case EParserViolationCode::PhdrsCommandIsIncomplete: return "PhdrsCommandIsIncomplete";
