...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciAPIs_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject QsciAPIs::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciAPIs.offsetsAndSizes,
    qt_meta_data_QsciAPIs,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciAPIs_t
, QtPrivate::TypeAndForceComplete<QsciAPIs, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
