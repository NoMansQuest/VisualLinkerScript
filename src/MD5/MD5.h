...
namespace VisualLinkerScript::MD5 {
   ...
   class CMD5Hasher {
       public:
            ...
            */
           CMD5Hasher(const void* input, const unsigned int input_length, void* signatureBuffer = NULL);
            ...
            * input_length - The length of the buffer.
            */
           void ProcessBlock(const void* input, const unsigned int input_length);
            ...
            * ARGUMENTS:
            *
             * signatureBuffer - A 16 byte buffer that will contain the MD5 signature.
             */
            void GetSignature(void* signatureBuffer);
             ...
             */
            void GetSignatureString(void* str_);
        ...
        private:
            ...
            unsigned char stored[VisualLinkerScript::MD5::BLOCK_SIZE * 2];  /* stored bytes */
