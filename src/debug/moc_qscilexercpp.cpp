...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QsciLexerCPP_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject QsciLexerCPP::staticMetaObject = { {
    ...
    qt_meta_stringdata_QsciLexerCPP.offsetsAndSizes,
    qt_meta_data_QsciLexerCPP,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QsciLexerCPP_t
