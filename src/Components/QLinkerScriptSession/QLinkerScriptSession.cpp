...
#include "Components/QLinkerScriptSession/EditorAction/SEditorRemoveContent.h"
#include "Components/QLinkerScriptSession/EditorAction/SEditorRemoveLine.h"
#include "Components/QLinkerScriptSession/EditorAction/SEditorReplaceContent.h"
#include "Components/QLinkerScriptSession/EditorAction/SEditorSelectText.h"
...
void QLinkerScriptSession::EditorContentUpdated()
{
    ...
    qint64 elapsedTimeNs = timer.nsecsElapsed(); // Get the elapsed time in nanoseconds
    qDebug() << "Lexing took" << elapsedTimeNs << "nanoseconds.";
...
void QLinkerScriptSession::DeferredContentProcessingAction()
{
    ...
    qint64 elapsedTimeNs = timer.nsecsElapsed(); // Get the elapsed time in nanoseconds
    qDebug() << "Parsing took" << elapsedTimeNs << "nanoseconds.";
