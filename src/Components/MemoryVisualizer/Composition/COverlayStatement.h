...
namespace VisualLinkerScript::Components::MemoryVisualizer::Composition
{
    ...
    {       
        DECLARE_READONLY_PROPERTY(std::shared_ptr<LinqVector<COverlaySectionStatement>>, OverlaySections)
        DECLARE_READONLY_PROPERTY(std::string, LoadRegion)

        /// @brief Default constructor.    	
        COverlayStatement(
				const CFillExpressionButton& fillExpression,
				std::shared_ptr<LinqVector<CProgramHeaderButton>> programHeaders,
				std::shared_ptr<LinqVector<COverlaySectionStatement>> childSections,
