...
/* BEGIN: To be added to "iface" file before creating a pull-request for official Scintilla repository */
...
#define SCE_LINKERSCRIPT_COMMENTS 6
#define SCE_LINKERSCRIPT_STRINGS 7
/* END */
