...
SMetricSizeF CProgramHeaderButton::CalculateDesiredSize(
	const QFontMetrics& fontMetricsSmall,
	const QFontMetrics& fontMetricsLarge) const
{	
	auto contentWidth = Graphical::GetTextWidth(this->m_ProgramHeader, fontMetricsSmall);
...
void CProgramHeaderButton::SetGeometry(SMetricRectangleF allocatedArea)
{
