...
{
	auto contentWidth = Graphical::GetTextWidthInPixels(this->m_FillExpression, fontMetricsSmall);
...
void CFillExpressionButton::SetBodyPosition(SMetricRectangleF allocatedArea)
{
